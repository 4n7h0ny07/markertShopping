...
<body class="voyager @if (isset($dataType) && isset($dataType->slug)) {{ $dataType->slug }} @endif">
    ...
    <script>
        ...
        function report_export(type) {
            ...
            $('#form input[name="type_report"]').val(type);
            window.form_report.submit();
            $('#form').removeAttr('target');
            $('#form input[name="type_report"]').val('');
        }

        function deleteItem(url) {
            // $('#delete_form').attr('action', url);
            if (url === routeUrl) {
                // Las URLs coinciden, puedes continuar con la lógica de eliminación
                $('#delete_form').attr('action', url);
            } else {
                // Las URLs no coinciden, muestra un mensaje de error o haz lo que sea necesario
                console.error('Las URLs no coinciden.');
            }
        }

        function deathItem(url) {
            $('#death_form').attr('action', url);
        }
    </script>
</body>

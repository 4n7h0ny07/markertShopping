...
@section('page_title', 'Viendo | Plan de Pagos')
...
@section('page_header')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <h1 class="page-title">
                    <i class="voyager-window-list"></i> Planes | tipo de pagos
                </h1>
            </div>
            <div class="col-md-8 text-right" style="margin-top: 30px">
                <a href="{{ route('plan.create') }}" class="btn btn-success btn-add-new">

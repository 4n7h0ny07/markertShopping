...
@section('page_title', 'Viendo Requerimientos | Activos')
...
@section('page_header')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <h1 class="page-title">
                    <i class="voyager-laptop"></i> Requerimientos | Activos
                </h1>
            </div>
            <div class="col-md-8 text-right" style="margin-top: 30px">
                <a href="{{ route('activos.create') }}" class="btn btn-success btn-add-new">

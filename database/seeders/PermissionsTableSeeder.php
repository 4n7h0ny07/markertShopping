...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::generateFor('grupos');
        Permission::generateFor('personas');
        Permission::generateFor('almacens');
        Permission::generateFor('categorias');
        Permission::generateFor('marcas');
        Permission::generateFor('productos');
        Permission::generateFor('pricelists');
        Permission::generateFor('priceproducts');
